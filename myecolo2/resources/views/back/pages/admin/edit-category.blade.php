...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Modification Catégorie')
@section('content')
    <div class="row">
        <div class="col-md-12">
                <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                                <div class="pull-left">
                                        <h4 class="text-dark">Modifier la catégorie</h4>
                                </div>
                        ...
                        <div class="row">
                                <div class="col-md-7">
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="category_name" placeholder="Entrez le nom de la catégorie" value="{{ $category->category_name }}">
                                                @error('category_name')
