    ...
    <div class="row pd-10">
        <div class="col-md-8 mb-20">
            <div class="card-box height-100-p pd-20" style="position: relative">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Entrez le nom du produit" value="{{ $product->name }}">
                ...
                <div class="form-group">
                    <label for=""><b>Image du produit :</b><small>Doit être carrée et d'une dimension maximale de (1080x1080)</small></label>
                    <input type="file" name="product_image" class="form-control">
                    <span class="text-danger error-text product_image_error"></span>
                </div>
                <div class="d-block mb-3" style="max-width: 250px;">
                  <img src="" class="img-thumbnail" id="image-preview" data-ijabo-default-img="/style_assets/img/products/{{ $product->product_image }}">
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-20">
            <div class="card-box min-height-200px pd-20 mb-20">
                ...
                {{-- <div class="form-group">
                    <label for=""><b>Sous-catégorie :</b></label>
            ...
            <div class="card-box min-height-200px pd-20 mb-20">
                <div class="form-group">
                    ...
                    <input type="text" name="price" class="form-control" placeholder="Ex: 23.99" value="{{ $product->price }}">
                    <span class="text-danger error-text price_error"></span>
                </div>
                <div class="form-group">
                    <label for=""><b>Prix de comparaison :</b><small>Optionnel</small></label>
                    <input type="text" name="compare_price" class="form-control" placeholder="Ex: 77.99" value="{{ $product->compare_price }}">
            ...
            <div class="card-box min-height-120px pd-20">
               <div class="form-group">
                 ...
                 <select name="visibility" id="" class="form-control">
                    ...
                    <option value="0" {{ $product->visibility == 0 ? 'selected' : '' }}>Privé</option>
                 </select>
               </div>
            </div>
        </div>
...
<script src="/extra-assets/dropzonejs/min/dropzone.min.js"></script>
    <script>
        //Aperçu de l'image du produit sélectionnée
        ...
        var myDropzone = new Dropzone('.dropzone', {
            ...
            parallelUploads:1, //Nombre de fichiers traités à la fois
            addRemoveLinks:true,
            maxFilesize:2, // 2MB
            acceptedFiles:'image/*',
            init:function(){
