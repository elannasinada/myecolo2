...
<div class="login-box bg-white box-shadow border-radius-10">
    ...
    <form action="{{ route('seller.login-handler') }}" method="POST">
        ...
        <div class="input-group custom">
            <input type="text" class="form-control form-control-lg" placeholder="Email" name="login_email" value="{{ old ('login_email')}}" >
        ...
        @error('login_email')
            <div class="alert alert-danger" style="margin-top: -25px; margin-bottom:15px;">
                {{ $message }}
            </div>
        @enderror
